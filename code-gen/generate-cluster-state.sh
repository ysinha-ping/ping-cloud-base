...
export IRSA_OPENSEARCH_ROLE_ARN=${IRSA_OPENSEARCH_ROLE_ARN:-''}
...
(
  ...
  # Bare ARN form (no annotation prefix) for the p1as-opensearch chart values.
  set_var "IRSA_OPENSEARCH_ROLE_ARN" "" "${ACCOUNT_BASE_PATH}" "${ENV}/irsa-role/opensearch/arn" '${ssm_value}'
